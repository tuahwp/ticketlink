...
const MIGRATION_STATEMENTS = [
  ...
  `DO $$ BEGIN CREATE TYPE "SparePartRequestStatus" AS ENUM ('REQUESTED', 'ALLOCATED', 'DISPATCHED', 'INSTALLED', 'ON_LOAN', 'RETURN_IN_TRANSIT', 'RETURNED', 'CANCELLED'); EXCEPTION WHEN duplicate_object THEN null; END $$;`,
