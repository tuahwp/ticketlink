...
const MIGRATION_STATEMENTS = [
  ...
  `ALTER TABLE "Ticket" ADD COLUMN IF NOT EXISTS "totalPausedMs" DOUBLE PRECISION NOT NULL DEFAULT 0;`,
  `ALTER TABLE "Ticket" ALTER COLUMN "totalPausedMs" TYPE DOUBLE PRECISION;`,
